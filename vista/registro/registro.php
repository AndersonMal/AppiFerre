	...
	<div class="row m-0 h-100">
        ...
        <div class="col p-0">
            ...
            <div class="text-header m-5 agrandar">
                <h1>Registrate</h1>
                <h5>Encuentra los mejores productos</h5>
                <hr>
                <form class="mt-5">
                    <input name="nombre" required id="nombre" class="login-input mt-2 p-3" type="text" placeholder="Nombre">
                    <input name="apellido" required id="apellido" class="login-input mt-2 p-3" type="text" placeholder="Apellido">
                    <input name="correo" required id="correo" class="login-input mt-2 p-3" type="email" placeholder="Correo electronico">
                    <input name="password1" required id="password1" class="login-input mt-2 p-3" type="password" placeholder="Contraseña">
                    <input name="password2" required id="password2" class="login-input mt-2 p-3" type="password" placeholder="Repita la contraseña">
                </form>
                <button id="registrarse" class="mt-4 btn-registro"><i class="fa fa-user-plus"></i> Regístrate</button>
                <hr>
